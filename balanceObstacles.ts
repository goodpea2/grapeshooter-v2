...
export interface Obstacle {
  ...
  type: string;
  health: number;
  // Add other properties of an obstacle as needed
}
...
export const overlayTypes: any = {
  ...
  ov_stray: { 
    ...
    assetImgConfig: { idleAssetImg: ['img_seed_stray_t2'], randomRotation: false, randomFlip: false }
  },
  ov_sniper_tower: { 
    name: 'Sniper Tower', 
    minHealth: 300, 
    ...
    enemyTurretConfig: { 
      ...
      barrelLockDurationBeforeFiring: 60,
      drawAimingLine: true
    },
    isDanger: true
  },
  ov_mortar_tower: {
    ...
    isEnemy: true,
    isValuable: false,
    obstacleOverlayVfx: 'v_mortar_tower',
    isConcealedAlongWithObstacle: false,
    enemyTurretConfig: {
      sightRadius: 400,
      shootRange: GRID_SIZE * 12,
      shootFireRate: 720,
      bulletTypeKey: 'b_enemy_mortar_shell',
      seeThroughObstacles: true,
      barrelLockDurationBeforeFiring: 30,
      drawAimingLine: true
    },
    isDanger: true
  },
  ov_minigun_tower: {
    ...
    isEnemy: true,
    isValuable: false,
    obstacleOverlayVfx: 'v_minigun_tower',
    isConcealedAlongWithObstacle: false,
    enemyTurretConfig: {
      sightRadius: 300,
      shootRange: GRID_SIZE * 8,
      shootFireRate: [180, 6, 6, 6, 6, 6],
      inaccuracy: 15,
      bulletTypeKey: 'b_enemy_minigun',
      seeThroughObstacles: true,
      barrelLockDurationBeforeFiring: 30,
      drawAimingLine: true
    },
  ...
  ov_healing_tower: {
    ...
    isEnemy: true,
    isValuable: false,
    obstacleOverlayVfx: 'v_healing_tower',
    isConcealedAlongWithObstacle: false,
    enemyTurretConfig: {
      sightRadius: 400,
      shootRange: 400,
      shootFireRate: 120,
      bulletTypeKey: 'b_enemy_healing_pulse',
      seeThroughObstacles: true,
      barrelLockDurationBeforeFiring: 0,
      drawAimingLine: false
    },
    isDanger: true
  },
  ov_firewall_tower: {
    ...
    isEnemy: true,
    isValuable: false,
    obstacleOverlayVfx: 'v_firewall_tower',
    isConcealedAlongWithObstacle: false,
    enemyTurretConfig: {
      sightRadius: 120,
      shootRange: 120,
      shootFireRate: [30, 30, 30, 60],
      bulletTypeKey: 'b_enemy_pulse',
      seeThroughObstacles: false,
      barrelLockDurationBeforeFiring: 0,
      drawAimingLine: false
    },
    isDanger: true
