...
export const t3_skymortar: TurretConfig = { 
  name: 'Sky Mortar', costs: { sun: 70 }, costAlmanac: { leaf: 10, fuel: 10, ice: 4 }, drops: { leaf: 1, fuel: 1, ice: 1 }, health: 100, color: [50, 100, 255], size: 22, tier: 3,
